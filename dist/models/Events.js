...
const Events = _1.sequelize.define("Events", {
    id: {
    ...
    eventId: { type: sequelize_1.DataTypes.INTEGER, unique: true, allowNull: false, comment: "Event Id of the lost or found item" },
