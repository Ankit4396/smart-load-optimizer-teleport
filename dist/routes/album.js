...
const album = __importStar(require("../controllers/album"));
const global_1 = require("../validators/global");
const album_1 = require("../validators/album");
module.exports = [
    {
        method: 'GET',
        path: '/album',
        handler: album.listAll,
        options: {
            tags: ["api", "Album"],
            notes: "List album images",
            ...
            validate: {
                ...
                query: album_1.listAlbumRequest,
